...
import { TrendingDown, TrendingUp, Activity, ArrowLeft, BicepsFlexed, Footprints, PersonStanding } from 'lucide-react';
...
const ExerciseOnboarding: React.FC = () => {
  const { updateGoal, updateFocus, completeSetup, goal, focus } = useExercise();
      ...
      <div className="onboarding-content">
        ...
        {step === 2 && (
          <div className="step-wrapper animate-slide-left">
            ...
            <p className="step-subtitle">Selecione para gerar sua ficha.</p>
